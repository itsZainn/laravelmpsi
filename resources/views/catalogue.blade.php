        ...
        <main class="my-1">
            <div class="flex flex-col items-center">
                <div class="relative m-6 max-w-lg mx-auto">
                    ...
                    <input
                        class="w-full border rounded-md pl-10 pr-16 py-2 focus:border-blue-500 focus:outline-none focus:shadow-outline"
            ...
            <div class="container mx-auto px-6 ">
                ...
                <div class="mt-1">
                    <h3 class="text-gray-600 text-2xl font-medium">Collect Your Dream Fish</h3>
                    <div class="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 mt-6">
                        @forelse ($fish as $ikan)
                            <div class="w-full max-w-sm mx-auto rounded-md shadow-md overflow-hidden">
                                <div class="flex items-end justify-end h-56 w-full bg-cover"
                                    style="background-image: url('{{ asset('images/' . $ikan->img) }}')">
                                    <button
                                ...
                                <div class="px-5 py-3">
                                    <h3 class="text-gray-700 uppercase">{{ $ikan->fishname }}</h3>
                                    <span class="text-gray-500 mt-2">Rp
                                        {{ number_format($ikan->harga, 0, ',', '.') }}</span>
                                    <p class="text-gray-600">{{ $ikan->keterangan }}</p>
                                </div>
                            </div>
                        @empty
